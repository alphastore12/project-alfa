<div class="container-fluid px-4">
    <div class="mb-3">
        <h5 class="mt-4">Add Customers</h5>
        <a href="/customers" class="btn btn-sm btn-danger mb-2">Back</a>
    </div>

    <form action="/customers/<?= $items['id'] ?>" method="post">
        <input type="hidden" name="_method" value="PUT" />
        <div class="mb-3">
            <label for="code" class="from-label">Code</label>
            <input type="text" name="code" id="code" class="form-control" value="<?= $items['code'] ?>">
        ...
        <div class="mb-3">
            ...
            <input type="text" name="status_id" id="status_id" class="form-control" value="<?= $items['status_id'] ?>">
